...
新版後端首次收到預約時，會保留「住宿預約」工作表第 27–31 欄的舊版伙食欄位，並以第 32–34 欄記錄「加購數量」、「伙食計價單位」與「單位價格」。既有第 1–26 欄及 Email 狀態欄位置不變。
...
4. 分別確認乾飼料／套組依「每隻貓 × 加購天數」計價，罐頭則依整筆預約的總罐數計價、不再乘以貓咪數量，且加購天數不會超過住宿晚數。
